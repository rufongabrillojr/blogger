...
import {googleapis, blogger} from '../constants/key';
...
export const sendRequest = async ({path, method = 'GET', data = {}, base, headers}) => {
    let url = base ? base + path : googleapis + path;
    let config = {
      crossDomain: true,
      headers: {
    ...
    console.info('%cNew connection has established', 'color: green');
